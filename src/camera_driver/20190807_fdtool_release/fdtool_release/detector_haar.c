...
If compiled with the "OMP" compilation flag
  ...
  mex -v -DOMP  detector_haar.c "C:\Program Files (x86)\Intel\Composer XE 2013\mkl\lib\intel64\mkl_core.lib"  "C:\Program Files (x86)\Intel\Composer XE 2013\mkl\lib\intel64\mkl_intel_thread.lib"
