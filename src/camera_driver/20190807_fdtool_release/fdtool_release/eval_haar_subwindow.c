...
/*
  ...
  mex -v -DOMP  eval_haar_subwindow.c "C:\Program Files (x86)\Intel\Composer XE 2013\mkl\lib\intel64\mkl_core.lib"  "C:\Program Files (x86)\Intel\Composer XE 2013\mkl\lib\intel64\mkl_intel_thread.lib"
...
double eval_haar_subwindow(unsigned char *I , int Ny , int Nx  , struct model detector , double *yfx)
{
	...
	double epsi  = detector.epsi , lambda = detector.lambda;
	double sum , sum_total = 0.0, a , b , th , thresh , fx ;	
